...
void
MEAMBO::meam_checkindex(int num, int lim, int nidx, int* idx /*idx(3)*/, int* ierr)
{
  //: idx[0..2]
  *ierr = 0;
  if (nidx < num) {
...
void
MEAMBO::meam_setup_param(int which, double value, int nindex, int* index /*index(3)*/, int* errorflag)
{
  //: index[0..2]
  int i1, i2;
  lattice_t vlat;
  *errorflag = 0;
  ...
  switch (which) {
    ...
    case 23:
      ...
      if (*errorflag != 0)
        return;
      this->rcutBC_meambo[index[0]] = value;
      break;

    //     24 = vdW_form
    case 24:
      this->vdW_form = (int)value;
      break;
    ...
    case 25:
      ...
      if (*errorflag != 0)
        return;
      this->evdW_96LJ_meambo[index[0]] = value;
      break;
    ...
    case 26:
      ...
      if (*errorflag != 0)
        return;
      this->svdW_96LJ_meambo[index[0]] = value;
      break;
