...
PairStyle(meambo,PairMEAMBO)

#else

#ifndef LMP_PAIR_MEAMBO_H
#define LMP_PAIR_MEAMBO_H
...
class PairMEAMBO : public Pair {
 public:
  PairMEAMBO(class LAMMPS *);
  ~PairMEAMBO();
 ...
 private:
  ...
  void allocate();
  void read_files(char *, char *, char *);
